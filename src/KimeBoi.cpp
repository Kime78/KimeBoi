...
void Processor::_Memory::write(unsigned short address, unsigned char value,
  ...
  if (address == 0xff00) {
    ram[0xff00 - 0x8000] =
        (value & 0b00110000) | (ram[0xff00 - 0x8000] & 0b11001111);
    return;
  }
...
bool isBitSet(std::uint8_t num, std::uint8_t bit) { return (num & (1 << bit)); }
...
int Processor::emulateCycle() {
  ...
  case 0x12: // good
  {
    ...
    // std::cout << (int)(Registers.D << 8 | Registers.E) << ": " <<(int)
    // Registers.A << std::endl;
  ...
  case 0x27: {
    ...
    std::uint16_t correction = Flags.C ? 0x60 : 0x00;
  ...
  case 0x29: // good
  {
    ...
    std::uint16_t hl = Registers.H << 8 | Registers.L;
    Flags.N = 0;
    Flags.H = (((((Registers.H << 8 | Registers.L) & 0xfff) +
                 ((Registers.H << 8 | Registers.L) & 0xfff)) &
                0x1000) == 0x1000);
    Flags.C = (((((Registers.H << 8 | Registers.L) & 0xffff) +
                 ((Registers.H << 8 | Registers.L) & 0xffff)) &
                0x10000) == 0x10000);
    hl = hl + hl;
    Registers.H = hl >> 8;
    Registers.L = hl & 0xFF;
  ...
  {
    Flags.N = 0;
    std::uint8_t hl = Memory.read(Registers.H << 8 | Registers.L, 0);
  ...
  case 0x39: // fixed
  {
    ...
    Flags.N = 0;
    if (((((Registers.H << 8 | Registers.L) & 0xfff) + (sp & 0xfff)) &
         0x1000) == 0x1000)
      Flags.H = 1;
    else {
      Flags.H = 0;
    ...
    if (((((Registers.H << 8 | Registers.L) & 0xffff) + (sp & 0xffff)) &
         0x10000) == 0x10000)
      Flags.C = 1;
    else {
      Flags.C = 0;
  ...
  case 0x88: {
    ...
    Flags.H = ((((Registers.A & 0xf) + (Registers.B & 0xf) + Flags.C) & 0x10) ==
               0x10);
    Flags.C = ((((Registers.A & 0xff) + (Registers.B & 0xff) + Flags.C) &
                0x100) == 0x100);
    Flags.Z = (res == 0);
    Registers.A = res;
    pc += 1;
  ...
  case 0x89: {
    ...
    Flags.H = ((((Registers.A & 0xf) + (Registers.C & 0xf) + Flags.C) & 0x10) ==
               0x10);
    Flags.C = ((((Registers.A & 0xff) + (Registers.C & 0xff) + Flags.C) &
                0x100) == 0x100);
    Flags.Z = (res == 0);
    Registers.A = res;
    pc += 1;
  ...
  case 0x8A: {
    ...
    Flags.H = ((((Registers.A & 0xf) + (Registers.D & 0xf) + Flags.C) & 0x10) ==
               0x10);
    Flags.C = ((((Registers.A & 0xff) + (Registers.D & 0xff) + Flags.C) &
                0x100) == 0x100);
    Flags.Z = (res == 0);
    Registers.A = res;
    pc += 1;
  ...
  case 0x8B: {
    ...
    Flags.H = ((((Registers.A & 0xf) + (Registers.E & 0xf) + Flags.C) & 0x10) ==
               0x10);
    Flags.C = ((((Registers.A & 0xff) + (Registers.E & 0xff) + Flags.C) &
                0x100) == 0x100);
    Flags.Z = (res == 0);
    Registers.A = res;
    pc += 1;
  ...
  case 0x8C: {
    ...
    Flags.H = ((((Registers.A & 0xf) + (Registers.H & 0xf) + Flags.C) & 0x10) ==
               0x10);
    Flags.C = ((((Registers.A & 0xff) + (Registers.H & 0xff) + Flags.C) &
                0x100) == 0x100);
    Flags.Z = (res == 0);
    Registers.A = res;
    pc += 1;
  ...
  case 0x8D: {
    ...
    Flags.H = ((((Registers.A & 0xf) + (Registers.L & 0xf) + Flags.C) & 0x10) ==
               0x10);
    Flags.C = ((((Registers.A & 0xff) + (Registers.L & 0xff) + Flags.C) &
                0x100) == 0x100);
    Flags.Z = (res == 0);
    Registers.A = res;
    pc += 1;
  ...
  case 0x8E: {
    std::uint8_t res =
        Registers.A + Memory.read(Registers.H << 8 | Registers.L) + Flags.C;

    Flags.N = 0;
    Flags.H =
        ((((Registers.A & 0xf) +
           (Memory.read(Registers.H << 8 | Registers.L, 0) & 0xf) + Flags.C) &
          0x10) == 0x10);
    Flags.C =
        ((((Registers.A & 0xff) +
           (Memory.read(Registers.H << 8 | Registers.L, 0) & 0xff) + Flags.C) &
          0x100) == 0x100);
    Flags.Z = (res == 0);
  ...
  case 0x8F: {
    ...
    Flags.H = ((((Registers.A & 0xf) + (Registers.A & 0xf) + Flags.C) & 0x10) ==
               0x10);
    Flags.C = ((((Registers.A & 0xff) + (Registers.A & 0xff) + Flags.C) &
                0x100) == 0x100);
    Flags.Z = (res == 0);
    Registers.A = res;
    pc += 1;
  ...
  case 0x90: {
    ...
    Flags.C =
        ((((Registers.A & 0xff) - (Registers.B & 0xff)) & 0x100) == 0x100);
    Registers.A -= Registers.B;
    pc++;
    break;
  }
  case 0x91: {
    ...
    Flags.C =
        ((((Registers.A & 0xff) - (Registers.C & 0xff)) & 0x100) == 0x100);
    Registers.A -= Registers.C;
    pc++;
    break;
  }
  case 0x92: {
    ...
    Flags.C =
        ((((Registers.A & 0xff) - (Registers.D & 0xff)) & 0x100) == 0x100);
    Registers.A -= Registers.D;
    pc++;
    break;
  }
  case 0x93: {
    ...
    Flags.C =
        ((((Registers.A & 0xff) - (Registers.E & 0xff)) & 0x100) == 0x100);
    Registers.A -= Registers.E;
    pc++;
    break;
  }
  case 0x94: {
    ...
    Flags.C =
        ((((Registers.A & 0xff) - (Registers.H & 0xff)) & 0x100) == 0x100);
    Registers.A -= Registers.H;
    pc++;
    break;
  }
  case 0x95: {
    ...
    Flags.C =
        ((((Registers.A & 0xff) - (Registers.L & 0xff)) & 0x100) == 0x100);
    Registers.A -= Registers.L;
    pc++;
    break;
  }
  case 0x96: {
    ...
    if ((((Registers.A & 0xf) -
          (Memory.read(Registers.H << 8 | Registers.L, 0) & 0xf)) &
         0x10) == 0x10)
      Flags.H = 1;
    else
      Flags.H = 0;
    if ((((Registers.A & 0xff) -
          (Memory.read(Registers.H << 8 | Registers.L, 0) & 0xff)) &
         0x100) == 0x100)
      Flags.C = 1;
    else
      Flags.C = 0;
    Registers.A -= Memory.read(Registers.H << 8 | Registers.L, 0);
    pc++;
    break;
  }
  case 0x97: {
    ...
    Flags.C =
        ((((Registers.A & 0xff) - (Registers.A & 0xff)) & 0x100) == 0x100);
    Registers.A -= Registers.A;
    pc++;
    break;
  }
  ...
  case 0xAE: // fixed
  {
    if ((Registers.A ^ Memory.read(Registers.H << 8 | Registers.L, 0)) == 0)
      Flags.Z = 1;
    else
      Flags.Z = 0;
    Flags.N = 0;
  ...
  case 0xBE: // needs confirmation
  {
    ...
    Flags.N = 1;
    if ((((Registers.A & 0xf) -
          (Memory.read(Registers.H << 8 | Registers.L) & 0xf)) &
         0x10) == 0x10)
      Flags.H = 1;
    else
      Flags.H = 0;
  ...
  case 0xC6: // fixed
  {
    ...
    if (result == 0)
      ...
      Flags.Z = 0;
    Flags.N = 0;
    if ((((Registers.A & 0xf) + (Memory.read(pc + 1, 0) & 0xf)) & 0x10) == 0x10)
      Flags.H = 1;
    else
      Flags.H = 0;
    if ((((Registers.A & 0xff) + (Memory.read(pc + 1, 0) & 0xff)) & 0x100) ==
        0x100)
      Flags.C = 1;
    else
      Flags.C = 0;
  ...
  case 0xCB: {
    ...
    case 0x4E: {
      Flags.Z =
          (((Memory.read(Registers.H << 8 | Registers.L) & 0x2) >> 1) == 0);
      Flags.N = 0;
      Flags.H = 1;
    ...
    case 0x56: {
      Flags.Z =
          (((Memory.read(Registers.H << 8 | Registers.L) & 0x4) >> 2) == 0);
      Flags.N = 0;
      Flags.H = 1;
    ...
    case 0x5E: {
      Flags.Z =
          (((Memory.read(Registers.H << 8 | Registers.L) & 0x8) >> 3) == 0);
      Flags.N = 0;
      Flags.H = 1;
    ...
    case 0x66: {
      Flags.Z =
          (((Memory.read(Registers.H << 8 | Registers.L) & 0x10) >> 4) == 0);
      Flags.N = 0;
      Flags.H = 1;
    ...
    case 0x6E: {
      Flags.Z =
          (((Memory.read(Registers.H << 8 | Registers.L) & 0x20) >> 5) == 0);
      Flags.N = 0;
      Flags.H = 1;
    ...
    case 0x76: {
      Flags.Z =
          (((Memory.read(Registers.H << 8 | Registers.L) & 0x40) >> 6) == 0);
      Flags.N = 0;
      Flags.H = 1;
    ...
    case 0x7E: {
      Flags.Z =
          (((Memory.read(Registers.H << 8 | Registers.L) & 0x80) >> 7) == 0);
      Flags.N = 0;
      Flags.H = 1;
    ...
    default: {
      std::cout << std::hex << (int)Memory.read(pc) << " "
  ...
  case 0xCE: {
    std::uint8_t res = Registers.A + Memory.read(pc + 1, 0) + Flags.C;
    // std::uint8_t tmp = Memory.read(pc + 1);

    Flags.H =
        ((((Registers.A & 0xf) + (Memory.read(pc + 1, 0) & 0xf) + Flags.C) &
          0x10) == 0x10);
    Flags.C =
        ((((Registers.A & 0xff) + (Memory.read(pc + 1) & 0xff) + Flags.C) &
          0x100) == 0x100);
    Flags.Z = (res == 0);
    Flags.N = 0;
  ...
  {
    std::uint8_t res = Registers.A - Memory.read(pc + 1, 0);
    if (res == 0)
      Flags.Z = 1;
    else
      Flags.Z = 0;
  ...
  case 0xDE: {
    ...
    Flags.H =
        ((((Registers.A & 0xf) - (Memory.read(pc + 1, 0) & 0xf) - Flags.C) &
          0x10) == 0x10);
    Flags.C =
        ((((Registers.A & 0xff) - (Memory.read(pc + 1, 0) & 0xff) - Flags.C) &
          0x100) == 0x100);
    Flags.Z = (res == 0);
    Registers.A = res;
  ...
  case 0xE0: {
    if (pc == 0xc2d7)
      pc = pc + 0;
    if (0xFF00 + Memory.read(pc + 1, 0) == 0xFF50) {
  ...
  case 0xEE: {
    if ((Registers.A ^ Memory.read(pc + 1, 0)) == 0)
      Flags.Z = 1;
    else
      Flags.Z = 0;
    Flags.N = 0;
  ...
  default: {
    std::cout << std::hex << (int)pc << ": " << (int)Memory.read(pc, 0) << "! "
              << std::endl;
    return Memory.cycles_taken;
  }
  }
